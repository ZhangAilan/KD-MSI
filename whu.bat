...
if %START_STEP% LEQ 2 if %END_STEP% GEQ 2 (
    ...
    if errorlevel 1 (
        echo Step 2 failed! Exiting pipeline.
        goto END
    )
...
if %START_STEP% LEQ 3 if %END_STEP% GEQ 3 (
    ...
    if errorlevel 1 (
        echo Step 3 failed! Exiting pipeline.
        goto END
    )
...
if %START_STEP% LEQ 4 if %END_STEP% GEQ 4 (
    ...
    if errorlevel 1 (
        echo Step 4 failed! Exiting pipeline.
        goto END
    )
...
if %START_STEP% LEQ 5 if %END_STEP% GEQ 5 (
    ...
    if errorlevel 1 (
        echo Step 5 failed! Exiting pipeline.
        goto END
    )
...
if %START_STEP% LEQ 6 if %END_STEP% GEQ 6 (
    ...
    if errorlevel 1 (
        echo Step 6 failed! Exiting pipeline.
        goto END
    )
