...
set EXPERIMENT_TAG=WHU_KD_T_minus_S_cat_CLIP_MSE10_nolinear_FocalDice
...
if %START_STEP% LEQ 1 (
    ...
    python train_classification_with_KD_CLIP.py --data_dir %DATA_DIR% --tag %EXPERIMENT_TAG% --teacher minus --student cat --batch_size 64
)
