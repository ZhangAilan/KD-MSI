...
if %START_STEP% LEQ 4 (
    ...
    python train_change_detection.py --data_dir %DATA_DIR% --tag LEVIR_weakly_change_detection --label_name LEVIR_KD_T_abs_S_cat@train@scale=0.5,1.0,1.25,2.0@crf=0@255 --fully_supervised False
)
